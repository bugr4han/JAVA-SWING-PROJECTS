...
public class HAFTA_9_0_DERS extends javax.swing.JFrame {
    public HAFTA_9_0_DERS() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Dinamik Kodlamaya Devam");
        setResizable(false);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
         try {    
            FileReader fr = new FileReader("Dosyalar/hafta9_konfigurasyon.txt");
    ...
    private void jMenuItem_KaydetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem_KaydetActionPerformed
        if (jFileChooser1.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                if (jCheckBox_A.isSelected())
                    kangrup = "A";
                if (jCheckBox_B.isSelected())
                    kangrup += "B";
                if (kangrup.equals(""))
                    kangrup = "0";
                if (jCheckBox_RH.isSelected())
                    kangrup += " Rh+";
                else 
                    kangrup += " Rh-";
                
                yaz.write("kangrup//"+kangrup+"\n"); 
                yaz.newLine();
                ...
                if (jRadioButton_Ogrenci.isSelected()) {
                    yaz.write("durum//1\n");
                    yaz.newLine();
                } else
                    yaz.write("durum//2\n");
                ...
                yaz.newLine();
                yaz.write("il//"+jComboBox_il.getSelectedIndex()+"\n");
                yaz.newLine();
                yaz.write("ilce//"+jComboBox_ilce.getSelectedIndex()+"\n");
                yaz.close();
                ...
                jTextArea_Adres.setText("");
                jCheckBox_A.setSelected(false);
                jCheckBox_B.setSelected(false);
                jCheckBox_RH.setSelected(false);
                jComboBox_il.setSelectedIndex(0);
                jComboBox_ilce.setSelectedIndex(0);
            } catch (IOException ee) {
                ...
                while (line != null) {
                    ...
                    switch(parcala[0]) {
                        ...
                        case "adres":
                            ...
                            break; 
                        case "il":
                            jComboBox_il.setSelectedIndex(Integer.valueOf(parcala[1]));
                            break;
                        case "ilce":
                            jComboBox_ilce.setSelectedIndex(Integer.valueOf(parcala[1]));
                            break;
                        case "durum":
                            if (parcala[1].equals("1"))
                                jRadioButton_Ogrenci.setSelected(true);
                            else
                                jRadioButton_Calisan.setSelected(true);
                            break;
                        case "kangrup":
                            jCheckBox_A.setSelected(false);
                            jCheckBox_B.setSelected(false);
                            jCheckBox_RH.setSelected(false);
                            if (parcala[1].contains("A"))
                                jCheckBox_A.setSelected(true);
                            if (parcala[1].contains("B"))
                                jCheckBox_B.setSelected(true);
                            if (parcala[1].contains("Rh+"))
                                jCheckBox_RH.setSelected(true);
                            break;
                        case "ilgi":
                            int[] secilenler = new int[parcala.length-1]; 
                            for(int i = 1; i < parcala.length; i++)
                                secilenler[i-1] = Integer.parseInt(parcala[i]); // Integer.valueOf(parcala[i]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HAFTA_9_0_DERS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HAFTA_9_0_DERS().setVisible(true);
            }
        });
    }
