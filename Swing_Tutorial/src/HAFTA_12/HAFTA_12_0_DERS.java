...
public class HAFTA_12_0_DERS extends javax.swing.JFrame {
    public HAFTA_12_0_DERS() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HAFTA_12_0_DERS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HAFTA_12_0_DERS().setVisible(true);
            }
        });
    }
